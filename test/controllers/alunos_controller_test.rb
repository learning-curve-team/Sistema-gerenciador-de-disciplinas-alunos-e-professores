...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { CPF: @aluno.CPF, Disciplina_id: @aluno.Disciplina_id, Nome: @aluno.Nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { CPF: @aluno.CPF, Disciplina_id: @aluno.Disciplina_id, Nome: @aluno.Nome } }
