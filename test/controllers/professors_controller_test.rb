...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { CPF: @professor.CPF, Disciplina_id: @professor.Disciplina_id, Nome: @professor.Nome } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { CPF: @professor.CPF, Disciplina_id: @professor.Disciplina_id, Nome: @professor.Nome } }
